...
@Singleton
class AppRoomRepository @Inject constructor (private val dao: myDao) : AppDatabaseRepository {

    suspend fun updateAllPaymentsRoomDatabase(list: List<PaymentModel>) =
        dao.updateAllPayments(list)
